...
import { FaUser, FaEnvelope, FaPhone, FaSave, FaTimes, FaEdit } from 'react-icons/fa';

const AdminProfileEditor = ({ user, onClose, onProfileUpdated }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(buildApiUrl('admin/update_profile.php'), {
        method: 'POST',
        headers: {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-md mx-auto">
      ...
      {!isEditing ? (
        <div className="space-y-4">
          ...
          <button
            onClick={handleEdit}
            className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors flex items-center justify-center"
          >
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3 pt-4">
            ...
            <button
              onClick={handleSave}
              disabled={loading}
              className="flex-1 bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 transition-colors flex items-center justify-center"
            >
              {loading ? (
