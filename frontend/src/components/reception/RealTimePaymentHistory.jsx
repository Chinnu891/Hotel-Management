...
const RealTimePaymentHistory = () => {
    ...
    }, [filters, currentPage, itemsPerPage, notificationsEnabled]);
    ...
    const handleNewPayment = useCallback((paymentData) => {
        ...
        setStats(prev => ({
            ...
            totalAmount: prev.totalAmount + parseFloat(paymentData.amount),
            todayPayments: prev.todayPayments + 1,
            todayAmount: prev.todayAmount + parseFloat(paymentData.amount),
            [paymentData.payment_method === 'cash' ? 'cashPayments' : 'onlinePayments']: 
                prev[paymentData.payment_method === 'cash' ? 'cashPayments' : 'onlinePayments'] + 1
        }));
    ...
    // Rest of the component methods (handlePaymentDetails, handleRefund, etc.)
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg">
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                                <p className="text-sm font-medium text-orange-600">Cash Payments</p>
                    ...
                    <div className="bg-indigo-50 p-4 rounded-lg">
                        <div className="flex items-center">
                            <span className="text-2xl mr-2">📱</span>
                            <div className="ml-3">
                                <p className="text-sm font-medium text-indigo-600">Online Payments</p>
                                <p className="text-2xl font-bold text-indigo-900">{stats.onlinePayments}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default RealTimePaymentHistory;
